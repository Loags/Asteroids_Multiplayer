...
public class NetworkObjectPool : NetworkBehaviour
{
    ...
    public static event OnInstantiatePool InstatiatePoolDone;
    ...
    public GameObject GetPrefabRef(ObjectTyp _typ)
    {
        GameObject prefabRef = null;
        foreach (var poolConfigObject in PooledPrefabsList)
        {
            if (_typ != poolConfigObject.Typ) continue;
            prefabRef = poolConfigObject.Prefab;
        }
